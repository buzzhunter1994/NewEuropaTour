...
return array (
    ...
    'Your message was successfully sent.' => 'Ваше повідомлення успішно відправлено.',
    'Your order was successfully sent.' => 'Ваш заказ успішно відправлено.',
    ...
    'TOP countries' => 'ТОП країни',
    'Thematics' => 'Тематика',
    'Tour thematics' => 'Тематика туру',
    'Transport type' => 'Тип транспорту',
    'Aviatour' => 'Авіатур',
    'Bus tour' => 'Автобусний тур',
    'show offers' => 'показати пропозиції',
    'Selection tours' => 'Підбір турів',
    'Nearest trip' => 'Найближчий виїзд',
    'booked place'=> 'Місце викуплено',
    'reserved place'=> 'Місце заброньовано',
    'choice place'=> 'Місце вибрано Вами',
    'empty place'=> 'Місце вільне для бронювания',
    'booked'=> 'Викупленні',
    'reserved'=> 'Заброньовані',
    'choice'=> 'Вибрані Вами',
    'empty'=> 'Вільні',
    'employeeReserved'=> 'Резерв для співробітників',
);
