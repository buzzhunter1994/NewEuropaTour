...
return array (
    ...
    'Your order was successfully sent.' => 'Ваш заказ успешно отправлен.',
    ...
    'Thematics' => 'Тематика',
    'Tour thematics' => 'Тематика тура',
    'Transport type' => 'Тип транспорта',
    'Aviatour' => 'Авиатур',
    'Bus tour' => 'Автобусный тур',
    'show offers' => 'показать предложения',
    'Selection tours' => 'Подбор туров',
    'Nearest trip' => 'Ближайший выезд',
    'booked place'=> 'Место выкуплено',
    'reserved place'=> 'Место забронировано',
    'choice place'=> 'Место выбрано Вами',
    'empty place'=> 'Место свободно для бронирования',
    'booked'=> 'Выкупленные',
    'reserved'=> 'Бронь',
    'choice'=> 'Вибранные Вами',
    'empty'=> 'Свободные',
    'employeeReserved'=> 'Резерв для сотрудников',
);
